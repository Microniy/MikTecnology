...
namespace MIKUnitTestProject
{
    public class Tests
    {
        ...
        {
            ILink n1 = factoryLink.Make("Link", "AssemblyNode", "ÑÌÒØ.123321.001-001");
            Assert.IsTrue(n1.Info is AssemblyNode);
            Assert.AreEqual((n1.Info as IVersion).Ver, 0);
            Assert.AreEqual((n1.Info as ICaption).Name, "ÑÌÒØ.123321.001-001");
            Assert.IsNull((n1.Info as IVersion).NextVersion1);
            ILink n2 = factoryLink.Make("Link", "AssemblyNode", "ÑÌÒØ.123321.001-001", -1);
            Assert.IsTrue(n2.Info is AssemblyNode);
            Assert.AreEqual((n2.Info as IVersion).Ver, 1);
            Assert.AreEqual((n2.Info as ICaption).Name, "ÑÌÒØ.123321.001-001");
            Assert.AreEqual((n1.Info as IVersion).NextVersion1, n2.Info);
            Assert.AreEqual((n2.Info as IVersion).OldVersion1, n1.Info);
            ILink n3 = factoryLink.Make("Link", "AssemblyNode", "ÑÌÒØ.123321.002");
            Assert.IsTrue(n3.Info is AssemblyNode);
            Assert.AreEqual((n3.Info as IVersion).Ver, 0);
            Assert.AreEqual((n3.Info as ICaption).Name, "ÑÌÒØ.123321.002");
            Assert.IsNull((n3.Info as IVersion).NextVersion1);
            ILink n4 = factoryLink.Make("Link", "AssemblyNode", "ÑÌÒØ.123321.002", -1);
            Assert.IsTrue(n4.Info is AssemblyNode);
            Assert.AreEqual((n4.Info as IVersion).Ver, 1);
            Assert.AreEqual((n4.Info as ICaption).Name, "ÑÌÒØ.123321.002");
        ...
        {
            ILink n1 = factoryLink.Make("Link", StringTypeNode.AssemblyNode.ToString(), "ÑÌÒØ.123321.001-001");
        ...
        {
            SourceIntTypConvertor intTypConvertor = new SourceIntTypConvertor();
            ILink n1 = factoryLink.Make("Link", "DetailNode", "ÑÌÒØ.123321.001-001");
            Assert.IsNotNull(intTypConvertor.Convert((n1.Info as BaseInfoObject).TypeNode, typeof(string), null, null));
        }
        ...
        {
            ILink n1 = factoryLink.Make("Link", StringTypeNode.DetailNode.ToString(), "ÑÌÒØ.123321.001-001");
        ...
        {
            ILink n1 = factoryLink.Make("Link", StringTypeNode.DetailNode.ToString(), "ÑÌÒØ.123321.100");
            ILink n2 = factoryLink.Make("Link", StringTypeNode.AssemblyNode.ToString(), "ÑÌÒØ.123321.101");
            n1.AddNode(n2);
            Assert.AreEqual(n1.Children.Count, 0);
        ...
        public void MaterialNode_ICaption_NameCorrect()
        {
            ...
            (n1.Info as IMaterial).SetAssortment("Òðóáà");
            Assert.AreEqual((n1.Info as ICaption).Name, "Òðóáà  ");
            Assert.AreEqual((n1.Info as IMaterial).Assortment, "Òðóáà");
            (n1.Info as IMaterial).SetSize("20x30");
            Assert.AreEqual((n1.Info as ICaption).Name, "Òðóáà 20x30 ");
            Assert.AreEqual((n1.Info as IMaterial).Size, "20x30");
            (n1.Info as IMaterial).SetStandard("ÃÎÑÒ.12345-99");
            Assert.AreEqual((n1.Info as ICaption).Name, "Òðóáà 20x30 ÃÎÑÒ.12345-99");
            Assert.AreEqual((n1.Info as IMaterial).Standard, "ÃÎÑÒ.12345-99");
        }
        ...
        {
            SourceIntTypConvertor intTypConvertor = new SourceIntTypConvertor();
            ILink n1 = factoryLink.Make("Link", "MaterialNode", "ÑÌÒØ.123321.001-001");
            Assert.IsNotNull(intTypConvertor.Convert((n1.Info as BaseInfoObject).TypeNode, typeof(string), null, null));
        }
        ...
        {
            ILink n1 = factoryLink.Make("Link", StringTypeNode.MaterialNode.ToString(), "ÑÌÒØ.123321.001-001");
        ...
        {
            ILink n1 = factoryLink.Make("Link", StringTypeNode.DetailNode.ToString(), "ÑÌÒØ.123321.100");
            ILink n2 = factoryLink.Make("Link", StringTypeNode.MaterialNode.ToString(), "ÑÌÒØ.123321.101");
            n1.AddNode(n2);
            Assert.AreEqual(n1.Children.Count, 0);
            Assert.IsFalse(n1.Children.Contains(n2));
            n2.AddNode(n1);
        ...
        public void DatailNode_AddNode_Material()
        {
            ...
            Assert.IsNull((n1.Info as IMaterial).Size);
            Assert.IsNull((n1.Info as IMaterial).Standard);
            (n2.Info as IMaterial).SetAssortment("Êðóã");
            Assert.AreEqual((n2.Info as IMaterial).Assortment, "Êðóã");
            Assert.AreEqual((n1.Info as IMaterial).Assortment, "Êðóã");
            ...
            (n2.Info as IMaterial).SetStandard("ÃÎÑÒ");
            Assert.AreEqual((n2.Info as IMaterial).Standard, "ÃÎÑÒ");
            Assert.AreEqual((n1.Info as IMaterial).Standard, "ÃÎÑÒ");
            (n1.Info as IMaterial).SetAssortment("Òðóáà");
            Assert.AreEqual((n2.Info as IMaterial).Assortment, "Òðóáà");
            Assert.AreEqual((n1.Info as IMaterial).Assortment, "Òðóáà");
